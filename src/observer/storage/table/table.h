...
public:
  ...
  // TODO refactor
  RC create_index(Trx *trx, bool unique, const std::vector<const FieldMeta *> &field_metas, const char *index_name, const std::vector<VectorIdxProp> &vector_idx_props);
