...
public:
  ...
  RC create(LogHandler &log_handler, BufferPoolManager &bpm, const char *file_name, const bool unique,
      const std::vector<int> &field_ids, const std::vector<const FieldMeta *> &fields, int internal_max_size = -1,
      int leaf_max_size = -1);
  RC create(LogHandler &log_handler, DiskBufferPool &buffer_pool, const char *file_name, const bool unique,
      const std::vector<int> &field_ids, const std::vector<const FieldMeta *> &fields, int internal_max_size = -1,
      int leaf_max_size = -1);
