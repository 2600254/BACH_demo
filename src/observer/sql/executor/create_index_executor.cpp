...
RC CreateIndexExecutor::execute(SQLStageEvent *sql_event)
{
  ...
  return table->create_index(trx, create_index_stmt->unique(), create_index_stmt->field_meta(), create_index_stmt->index_name().c_str(), create_index_stmt->vector_idx_props());
}